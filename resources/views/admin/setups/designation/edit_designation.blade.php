        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Resignation Edit</h4>
                        ...
                        <div class="col">
                            <form action="{{ route('designation.update', $designation->id) }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-10 offset-1">
                                        ...
                                        <div class="form-group">
                                            <h5>Edit Resignation Name <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                ...
                                <div class="text-xs-right" style="float: right">
                                   <a href="{{ route('designation.view')}}" type="button" class="btn btn-rounded btn-info ">Back</a>
